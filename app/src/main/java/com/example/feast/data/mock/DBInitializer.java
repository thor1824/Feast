...
public class DBInitializer {
    ...
    private void generateRecipes() {
        Recipe recipe1 = new Recipe(ingredients, "someID", 20, "Ikke Flue i suppe");
        Recipe recipe2 = new Recipe(ingredients, "nextID", 30, "lort i nutella");
        Recipe recipe3 = new Recipe(ingredients, "AfterThatId", 20, "Skipperlapskov");
        Recipe recipe4 = new Recipe(ingredients, "WOWid", 40, "Fransk løgsuppe");
        Recipe recipe5 = new Recipe(ingredients, "WOWeeeeeid", 20, "Knepkager");
        Recipe recipe6 = new Recipe(ingredients, "WOWqweqweid", 30, "Arme riddere");
        Recipe recipe7 = new Recipe(ingredients, "WOwqerohkjgfWid", 40, "Benløse fugle");
        Recipe recipe8 = new Recipe(ingredients, "WOWioashfhd", 30, "Bøf Stroganoff");
        Recipe recipe9 = new Recipe(ingredients, "WOWiyasdfiuaod", 15, "Klapsammen mad");
        Recipe recipe10 = new Recipe(ingredients, "WOWbnasdfjgid", 30, "Bare kaffe");
        Recipe recipe11 = new Recipe(ingredients, "WOWijahgsdfhlaid", 60, "Italiansk pizza snitter");
        Recipe recipe12 = new Recipe(ingredients, "WOWijsghfahjugsdfd", 60, "After 8 Snitter");
        Recipe recipe13 = new Recipe(ingredients, "WOuhafgsukgasfWid", 20, "Elgiganten er klam");
